...
Will be modified according to students' programs and online lectures. Every week on Tuesday there will be recitation/office hour 14:40-16:30.

## Course Assistants

- Furkan Tokgöz tokgoz@metu.edu.tr (Coordinator, Office: ARC-300)
- Furkan Karakaya kfurkan@metu.edu.tr (Office: ARC-300)
...
- Not submitting to one laboratory report
- Not submitting to term project
...
- Week#8: [Introduction to DC/DC Converters](/presentations/ee463_buck_converters.html)
...
- Week#13: [Isolation, Gate Drivers](/presentations/ee463_isolation.html)
...
- Use a few  power electronic software (e.g. [Simulink](https://www.mathworks.com/products/simulink.html), [KiCad](https://kicad-pcb.org/), [Autodesk Fusion 360](https://www.autodesk.com.tr/education/edu-software/overview?sorting=featured&page=1)  etc.)
...
- In the course you will learn to use [Simulink](https://www.mathworks.com/products/simulink.html), [KiCad](https://kicad-pcb.org/), [Autodesk Fusion 360](https://www.autodesk.com/products/fusion-360/overview). Please set up these software and start learning them as soon as possible.
