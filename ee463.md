...
- Homeworks: 15% (+some bonus for good homeworks)
- Final: 28%
- Term Project: %18 (+some bonus for good projects)
- Participation: 4% (quizzes, pop-up questions, active participation)


**Important Note:** Any of the following actions will result in NA grade:

- Not submitting at least two homeworks
...
Presentations will be added to [keysan.me/ee463](http://keysan.me/ee463/) weekly and lecture videos will be added to Odtuclass and [Youtube](https://www.youtube.com/channel/UCkBWz-xDRrpYb7-jvklqIKA) (please also use the other sources given below):
...
- Week#3: [Three Phase Diode Rectifiers](http://keysan.me/presentations/ee463_three_phase_diode_rectifiers.html)
- Week#4: [Power Semiconductor Devices](http://keysan.me/presentations/ee463_power_semiconductor_devices.html)
- Week#5: [Review of DC/DC Converters](http://keysan.me/presentations/ee463_buck_converters.html)
- Week#6: [Regulated Power Supplies](/presentations/ee464_power_supplies.html)
- Week#8: [Magnetic Design for Power Electronics](/presentations/ee464_magnetic_design.html)
- Week#10: [Half/Full Bridge Converters](/presentations/ee464_bridge_converters.html)
...
- Week#10: [Other DC/DC converters](/presentations/ee464_cuk_sepic.html)
- Week#11: [Thermal Design](http://keysan.me/presentations/ee463_thermal_design.html)
- Week#12: [Snubbers](http://keysan.me/presentations/ee463_snubbers.html)
- Week#12: [Harmonics, Filters](http://keysan.me/presentations/ee463_filters.html)
- Week#14: [Isolation, Gate Drivers](http://keysan.me/presentations/ee463_isolation.html)
...
Assuming you are getting the core courses from the power engineering option, you will need at least four more courses. For electrical machines and power electronics area, you should definitely get [EE462](http://keysan.me/ee462/). Apart from that I can suggest the following courses (in the order of preference):
...
- University of Colorado [Introduction to Power Electronics](https://www.colorado.edu/ecee/online-masters/curriculum/power-electronics/ecea-5700-introduction-power-electronics)
...
- [MathWorks](https://www.mathworks.com/discovery/power-electronics-simulation.html)
...
- [KiCad](https://kicad-pcb.org/download/) is an open source PCB design software which is offered in their website for free.
- [Introduction to KiCad](https://docs.kicad.org/6.0/en/getting_started_in_kicad/getting_started_in_kicad.html)
- [Quick Start to KiCad](https://learn.sparkfun.com/tutorials/beginners-guide-to-kicad/all)
...
- In this course you will complete several short homeworks, and one hardware project. Homeworks will be performed in groups (2 people). However, the groups will be assigned randomly, and will be shuffled for each project. You will be able to choose your group partners only for the hardware project.
