...
![](presentations/magnet_repelling.png)
...
If you're planning to use FEMM, then the [examples](http://www.femm.info/wiki/Examples) page is very useful. In particular, have a look at these two examples:
