...
- Week#7 (02/04): Technical visit to Emtas
- Week#8 (09/04): [Main Machine Parameters](/presentations/ee564_machine_sizing.html)
- Week#8 (09/04): [Basic Machine Dimensions](/presentations/ee564_basic_machine_design.html)
...
- Week#8 (13/04): [Number of slots](/presentations/ee564_basic_machine_design2.html)
- Week#8 (14/04): [Carter's Coefficient, Effective Length](/presentations/ee564_tooth_flux.html) 
- Week#10 (27/04): [Magnetizing Current - Magnetic Losses](/presentations/ee564_magnetizing_current_losses.html)
...
Please choose one topic from below, and fill in the [online spreadsheet](https://docs.google.com/spreadsheets/d/173FqykIj7HfWxBJXid-JUIKdqOeXsMr1O3MJ19IN08g/edit?usp=sharing) to book your topic and date. One topic should be presented only once. First-come first served.
...
You are supposed to design a synchronous reluctance motror for the [BMW i3](http://en.wikipedia.org/wiki/BMW_i3), which is a full-electric car with a hybrid-synchronous motor. Although the motor is rated at 75 kW, it can produce instantaneous power up to 125 kW, and torque up to 250 Nm. Although the original motor is PM assisted, you can design a classical synchronous reluctance motor. You are free to use any software, but I personally advise you to use [SYRE](http://sourceforge.net/projects/syr-e/). Here are some useful links:
